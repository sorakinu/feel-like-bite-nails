...
​2. Let the Wind Clear the Path
Click the "Smooth with Wind" button at the bottom to erase your drawings and return to a calm, untouched shore.
（画面下の「風でならす」ボタンで消去し、静かな砂浜に戻ります。）
​3. Release Your Thoughts
If you have feelings you want to let go of, type them into the text box at the bottom right.
（想いがあれば、気が済むまで右下の四角枠に文字を書いてください。）
​4. Send Them into the Sand
Click the triangle button to let your thoughts dissolve and wash away into the sand.
（三角ボタンを押せば、想いを砂の中に流し去ることができます。）
